...
class SpatialTransformer(Layer):
    ...
    def _transform(self, affine_transformation, input_shape, output_size):
        ...
        affine_transformation = tf.cast(affine_transformation, 'float64')
           

        width = tf.cast(width, dtype='float64')
        height = tf.cast(height, dtype='float64')
        output_height = output_size[0]
        output_width = output_size[1]
        ...
        indices_grid = tf.cast(indices_grid,dtype='float64')
